...
import cn.xxjc.com.utils.DimensionUtil;
import cn.xxjc.com.utils.ImageUtil;
                ...
                public void run() {
                    try {
                        ...
                        handler.post(new Runnable() {
                            @Override
                            public void run() {
                                Bitmap bitmap = crop(new File(file,System.currentTimeMillis()+".jpg"), tempFile, rotation);
